...
urlpatterns = [
    ...
    path(
        'upload_data_campaign/<int:campaign_id>',
        views.upload_data_campaign,
        name='upload_data_campaign'),
    path(
        'download_poll_answers/<int:campaign_id>/<str:start_date>/<str:end_date>',
        views.download_poll_answers,
        name='download_poll_answers'),
    path(
        'download_fails_polls/<int:campaign>/<str:start_date>/<str:end_date>',
    ...
    path(
        ...
        name='replace_data_llamada'),
    path(
        'fail_prepare_polls',
        webservices.fail_prepare_polls,
        name='fail_prepare_polls'),
]
