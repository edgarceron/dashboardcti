...
class Referencias(models.Model):
    ...
    grupo = models.ForeignKey('ReferenciasSub3', models.DO_NOTHING, db_column='grupo')
    subgrupo = models.ForeignKey('ReferenciasSub3', models.DO_NOTHING, db_column='subgrupo')
    ...
    subgrupo2 = models.ForeignKey('ReferenciasSub3', models.DO_NOTHING, db_column='subgrupo2', blank=True, null=True)
    subgrupo3 = models.ForeignKey('ReferenciasSub3', models.DO_NOTHING, db_column='subgrupo3', blank=True, null=True)
...
class Terceros(models.Model):
    nit = models.DecimalField(primary_key=True, max_digits=18, decimal_places=0)
...
class CondicionesPago(models.Model):
    condicion = models.CharField(primary_key=True, max_length=4)
...
class Centros(models.Model):
    centro = models.IntegerField(primary_key=True)
    descripcion = models.CharField(max_length=50)
    grupo = models.ForeignKey('CentrosSubgrupos', models.DO_NOTHING, db_column='grupo')
    subgrupo = models.ForeignKey('CentrosSubgrupos', models.DO_NOTHING, db_column='subgrupo')
